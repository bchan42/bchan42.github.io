...
- Custom NER model to detect geospatial terms for QGIS mapping  
...
- Preprocessing, tuning, and performance evaluation  
...
- Evaluated outcome improvement from clustering  
...
- Built API endpoints for user auth and data access  
